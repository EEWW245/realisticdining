...
public class WokBlockEntity extends BaseContainerBlockEntity implements Container {
    ...
    private ItemStack getRecipeResult(ItemStack input) {
        ...
        return level.getRecipeManager().getRecipeFor(com.example.realisticdining.recipes.WokRecipe.WOK_RECIPE_TYPE.get(), recipeInput, level)
    ...
    public boolean hasHeatSource() {
        ...
        return KaleidoscopeCompat.isStoveLit(level, belowState);
    }
}
