...
public class LeftArmModel extends GeoModel<GeoAnimatable> {
    ...
    private static final ResourceLocation ANIMATION_RESOURCE =
            ResourceLocation.fromNamespaceAndPath(RealisticDining.MOD_ID, "animations/eat_rice.animation.json");
    ...
    public ResourceLocation getModelResource(GeoAnimatable animatable) {
        ...
        return ResourceLocation.fromNamespaceAndPath(RealisticDining.MOD_ID, MODEL_RESOURCES[biteIndex]);
    }
