...
public class RandomChanceCondition implements LootItemCondition {
    ...
    public static void register() {
        TYPE = Registry.register(
                ...
                new ResourceLocation(RealisticDining.MOD_ID, "random_chance_30_50"),
                new LootItemConditionType(new RandomChanceCondition.SnackSerializer())
        );
    }
    ...
    public static LootItemCondition.Builder builder() {
        return RandomChanceCondition::new;
    }

    public static class SnackSerializer implements Serializer<RandomChanceCondition> {
        @Override
        public void serialize(JsonObject json, RandomChanceCondition condition, JsonSerializationContext context) {
            // 无字段，无需序列化内容
        }

        @Override
        public RandomChanceCondition deserialize(JsonObject json, JsonDeserializationContext context) {
