...
/**
 * 材质包扩展物品的共用 GeoItem（Fabric 1.20.1）。
 *
 ...
 * <ul>
 *   <li>按下 U 键 → {@link com.example.realisticdining.fabric.network.PackAnimationPacket} 触发 {@code triggerAnim("eat", "eat")}</li>
...
public class PackEmpty extends Item implements GeoItem {
    ...
    public void createRenderer(java.util.function.Consumer<Object> consumer) {
        // 材质包扩展物品的渲染由 PackCustomRenderer 通过 mixin 接管，这里不需要实现
    }
}
