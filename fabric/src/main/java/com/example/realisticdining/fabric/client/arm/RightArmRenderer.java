...
public class RightArmRenderer extends GeoObjectRenderer<GeoAnimatable> {
    ...
    static {
        TEXTURE_GROUPS.put("chopstick", new ResourceLocation(RealisticDining.MOD_ID, "textures/item/chopsticks.png"));
        TEXTURE_GROUPS.put("chopstick2", new ResourceLocation(RealisticDining.MOD_ID, "textures/item/chopsticks.png"));
