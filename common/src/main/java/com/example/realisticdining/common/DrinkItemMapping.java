...
public final class DrinkItemMapping {
    ...
    private static final Map<String, Supplier<Item>> DRINK_TO_SUPPLIER = new HashMap<>();
    ...
    public static String getDrinkIdForItem(Item item) {
        for (Map.Entry<String, Supplier<Item>> e : DRINK_TO_SUPPLIER.entrySet()) {
    ...
    public static Item getItemForDrinkId(String drinkId) {
        Supplier<Item> sup = DRINK_TO_SUPPLIER.get(drinkId);
