...
public class WokMenu extends AbstractContainerMenu {
    ...
    public WokMenu(int id, Inventory inventory) {
        this(id, inventory, new WokBlockEntity(net.minecraft.core.BlockPos.ZERO, ModBlocks.WOK_BLOCK.get().defaultBlockState()));
    }
    ...
    public static WokMenu factory(int id, Inventory inventory, FriendlyByteBuf buf) {
        BlockPos pos = buf.readBlockPos();
        BlockEntity blockEntity = inventory.player.level().getBlockEntity(pos);
        if (blockEntity instanceof WokBlockEntity wokBlockEntity) {
            return new WokMenu(id, inventory, wokBlockEntity);
        }
        throw new IllegalStateException("TileEntity is not correct type!");
    }
}