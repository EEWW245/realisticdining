...
- `mode`: `static`,holding mode. shows the model immediately on pickup with procedural sway;
    `pickup` automatically plays a "pick up" animation on pickup and holds the final pose.
