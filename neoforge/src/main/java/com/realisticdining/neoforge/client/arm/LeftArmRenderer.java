...
public class LeftArmRenderer extends GeoObjectRenderer<GeoAnimatable> {
    ...
    private static final ResourceLocation OAK_PLANKS_TEXTURE = ResourceLocation.fromNamespaceAndPath("minecraft", "textures/block/oak_planks.png");

    static {
        TEXTURE_GROUPS.put("white_rice", ResourceLocation.fromNamespaceAndPath(RealisticDining.MOD_ID, "textures/item/white_rice.png"));
