...
public class RightArmModel extends GeoModel<GeoAnimatable> {
    ...
    private static final ResourceLocation MODEL_RESOURCE =
            ResourceLocation.fromNamespaceAndPath(RealisticDining.MOD_ID, "geo/eat_rice.geo_1.json");
    private static final ResourceLocation ANIMATION_RESOURCE =
            ResourceLocation.fromNamespaceAndPath(RealisticDining.MOD_ID, "animations/eat_rice_1.animation.json");
