...
public class RightHandChopsticksModel extends GeoModel<GeoAnimatable> {

    private static final ResourceLocation MODEL_RESOURCE =
            ResourceLocation.fromNamespaceAndPath(RealisticDining.MOD_ID, "geo/right_hand_chopsticks.geo.json");
